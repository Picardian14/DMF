function [opt_fc_error,opt_fcd_ks,opt_pars,results  ] = fit_CORR(T,emp_fc,emp_fcd,G,slope, nm, nm_bias,dmf_pars,opts)
%
...
if isempty(emp_fcd) % only optimizes FC
    ...
    function [fc_error,const,outdata] = aux_dmf_fit_fc(g_alpha) 
        ...
        fc_error = 1-corr2(emp_fc, sim_fc);
        outdata = {reg_fr,reg_ent, ssim_error, sim_fc, mse_error};
