...
mkdir Figuras/N3_FC/ MSE/
movefile Figuras/*plot.fig Figuras/N3_FC/MSE/
close all;
% Finetuning
...
mkdir Figuras/N3_FC/MSE/ Finetune/
movefile Figuras/*plot.fig Figuras/N3_FC/MSE/Finetune
close all;
%
% SSIM
%
experiment_name = 'N3_SSIM_Galpha';
checkoint_file = [strcat(basefold, checkpoint_folder),experiment_name,'_v1.mat'];
bo_opts = {'IsObjectiveDeterministic',false,'UseParallel',true,...
        'MinWorkerUtilization',4,...
        'AcquisitionFunctionName','expected-improvement-plus',...
...
mkdir Figuras/N3_FC/ SSIM/
movefile Figuras/*_plot.fig Figuras/N3_FC/SSIM/
close all;
% Finetuning
iniX = opt_res.BayesoptResults.XTrace;
iniObj = opt_res.BayesoptResults.ObjectiveTrace;
...
mkdir Figuras/N3_FC/SSIM/ Finetune/
movefile Figuras/*_plot.fig Figuras/N3_FC/SSIM/Finetune
close all;
%
%% CORR
%
experiment_name = 'N3_CORR_Galpha';
checkoint_file = [strcat(basefold, checkpoint_folder),experiment_name,'_v1.mat'];
bo_opts = {'IsObjectiveDeterministic',false,'UseParallel',true,...
        'MinWorkerUtilization',4,...
        'AcquisitionFunctionName','expected-improvement-plus',...
...
mkdir Figuras/N3_FC/ CORR/
movefile Figuras/*_plot.fig Figuras/N3_FC/CORR/
close all;
% Finetuning
iniX = opt_res.BayesoptResults.XTrace;
iniObj = opt_res.BayesoptResults.ObjectiveTrace;
...
mkdir Figuras/N3_FC/CORR/ Finetune/
movefile Figuras/*_plot.fig Figuras/N3_FC/CORR/Finetune
close all;
...
save("Results/N3_CORR_Galpha.mat", "simulationsFC5", "best_pars_corr")
h = figure();
imagesc(squeeze(mean(simulationsFC5 ,3)));
sim_fc = mean(simulationsFC5, 3);
disp(1-corr2(ave_fc, sim_fc))
